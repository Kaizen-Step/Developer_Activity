...
st.write(""" In this section, we try to dive deep into Electric Capital developer's Report findings about the Near ecosystem and make comparisons where ever is relevant. In this section there are some terms that might not be familiar to general audiance, GitHub is an online software development platform; used for storing, tracking, and collaborating on software projects. A commit, or "revision," is an individual change to undergoing project file (or set of files). A repository contains all of your project's files and each file's revision history. You can discuss and manage your project's work within the repository. Full-Time Developers are developers with 10+ days of contributions (Commit code in Guithub) in a month, Part-Time Developers are those with 2 to 9 days of contributions, and finally, One-Time Developers contribute only once in a month.  """)
